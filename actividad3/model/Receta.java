...
public class Receta {
	  ...
	  private String serial;
	    ...
	    public Receta(String serial, int dosis, int peso, String nombre, String origen, String metodoAplicacion,
				int fechaOrigen) {
			super();
			this.serial = serial;
			this.dosis = dosis;
		...
		public String toString() {
			return "Receta [serial=" + serial + ", dosis=" + dosis + ", peso=" + peso + ", nombre=" + nombre
					+ ", origen=" + origen + ", metodoAplicacion=" + metodoAplicacion + ", fechaOrigen=" + fechaOrigen
					+ "]";
		}
